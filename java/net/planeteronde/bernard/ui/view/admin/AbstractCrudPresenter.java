...
import net.planeteronde.bernard.backend.data.entity.AbstractEntity;
import net.planeteronde.bernard.backend.service.CrudService;
import net.planeteronde.bernard.backend.service.UserFriendlyDataException;
