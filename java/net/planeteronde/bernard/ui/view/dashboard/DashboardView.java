package net.planeteronde.bernard.ui.view.dashboard;
...
import net.planeteronde.bernard.backend.data.DashboardData;
import net.planeteronde.bernard.backend.data.DeliveryStats;
import net.planeteronde.bernard.backend.data.entity.Order;
import net.planeteronde.bernard.backend.data.entity.Product;
import net.planeteronde.bernard.backend.service.OrderService;
import net.planeteronde.bernard.ui.components.OrdersGrid;
import net.planeteronde.bernard.ui.navigation.NavigationManager;
import net.planeteronde.bernard.ui.view.orderedit.OrderEditView;
