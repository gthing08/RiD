...
import net.planeteronde.bernard.ui.view.admin.product.ProductAdminView;
import net.planeteronde.bernard.ui.view.admin.user.UserAdminView;
import net.planeteronde.bernard.ui.view.dashboard.DashboardView;
...
public class MainView extends MainViewDesign implements ViewDisplay {
	...
	@PostConstruct
	public void init() {
		attachNavigation(projets, ProjetView.class);
